...
# 2 "<built-in>" 2
# 1 "hls_FIR_STREAM/FIR.cpp" 2

# 1 "hls_FIR_STREAM/FIR.h" 1
...
__attribute__((sdx_kernel("fir_n11_strm", 0))) void fir_n11_strm(stream_t* pstrmInput, stream_t* pstrmOutput, int32_t an32Coef[(((11 + 3) >> 2) << 2)], reg32_t regXferLeng);
# 3 "hls_FIR_STREAM/FIR.cpp" 2

__attribute__((sdx_kernel("fir_n11_strm", 0))) void fir_n11_strm(stream_t* pstrmInput, stream_t* pstrmOutput, int32_t an32Coef[(((11 + 3) >> 2) << 2)], reg32_t regXferLeng)
{
#line 17 "/home/ubuntu/course-lab_2/hls_FIR_STREAM/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fir_n11_strm
# 5 "hls_FIR_STREAM/FIR.cpp"

#line 6 "/home/ubuntu/course-lab_2/hls_FIR_STREAM/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=fir_n11_strm
# 5 "hls_FIR_STREAM/FIR.cpp"
